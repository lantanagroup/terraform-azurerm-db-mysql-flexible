...
| <a name="input_delegated_subnet"></a> [delegated\_subnet](#input\_delegated\_subnet) | The ID of the Virtual Network Subnet to create the MySQL Flexible server. | <pre>object({<br/>    id = string<br/>  })</pre> | `null` | no |
